...
import { ref, computed, markRaw, reactive, watch, defineComponent, openBlock, createBlock, Teleport, createVNode, Transition, withCtx, createElementBlock, createElementVNode, normalizeClass, createCommentVNode, renderSlot, pushScopeId, popScopeId, createStaticVNode, resolveComponent, resolveDirective, Fragment, withDirectives, renderList } from 'vue';
...
function useEthers() {
    const chainId = computed(() => { var _a; return (_a = network$1.value) === null || _a === void 0 ? void 0 : _a.chainId; });
    return {
        // state
        isActivated,
        provider: provider$1,
...
function useMulticall(provider) {
    ...
    const multicall = new Contract(MULTICALL2_ADDRESS, MULTICALL2_ABI, provider);
...
class WalletConnectConnector extends Connector {
    ...
    getProvider() {
        return __awaiter(this, void 0, void 0, function* () {
            const WalletConnectProvider = (yield import('@walletconnect/web3-provider'))
                .default;
        ...
        (_ctx.modalOpen)
          ? (openBlock(), createElementBlock("div", _hoisted_1$5, [
              createElementVNode("div", {
                class: normalizeClass(_ctx.modalInnerClass)
              }, [
...
const _withScopeId$1 = n => (pushScopeId("data-v-04a0d67a"),n=n(),popScopeId(),n);
const _hoisted_1$4 = { class: "modal" };
const _hoisted_2$4 = /*#__PURE__*/ _withScopeId$1(() => /*#__PURE__*/createElementVNode("div", { class: "lds-ripple" }, [
...
const _withScopeId = n => (pushScopeId("data-v-e1ee1034"),n=n(),popScopeId(),n);
...
const _hoisted_8 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/createElementVNode("p", { class: "mt-4" }, "Approve or reject request using your wallet", -1 /* HOISTED */));
const _hoisted_9 = [
  _hoisted_7,
  _hoisted_8
];
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_CoinbaseWallet = resolveComponent("CoinbaseWallet");
  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    createVNode(_component_Modal, {
      ...
      default: withCtx(() => [
        withDirectives((openBlock(), createElementBlock("div", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.connectors, (connector, i) => {
            return (openBlock(), createElementBlock("div", {
              key: connector.name
            }, [
              createElementVNode("div", {
                class: normalizeClass(_ctx.walletItemClass),
                onClick: $event => (_ctx.connectWith(connector) && _ctx.close())
              }, [
                createElementVNode("div", _hoisted_2, [
                  (connector.name === 'metaMask')
                    ? (openBlock(), createBlock(_component_MetaMaskIcon, {
                        key: 0,
                        class: "logo"
                      }))
                    : createCommentVNode("v-if", true),
                  (connector.name === 'walletConnect')
                    ? (openBlock(), createBlock(_component_WalletConnectIcon, {
                        key: 1,
                        class: "logo"
                      }))
                    : createCommentVNode("v-if", true),
                  (connector.name === 'coinbaseWallet')
                    ? (openBlock(), createBlock(_component_CoinbaseWallet, {
                        key: 2,
                        class: "logo"
                      }))
                    : createCommentVNode("v-if", true),
                  (connector.name === 'metaMask')
                    ? (openBlock(), createElementBlock("div", _hoisted_3, "MeteMask"))
                    : createCommentVNode("v-if", true),
                  (connector.name === 'walletConnect')
                    ? (openBlock(), createElementBlock("div", _hoisted_4, "WalletConnect"))
                    : createCommentVNode("v-if", true),
                  (connector.name === 'coinbaseWallet')
                    ? (openBlock(), createElementBlock("div", _hoisted_5, " Coinbase Wallet "))
                    : createCommentVNode("v-if", true)
                ])
              ...
              (i !== _ctx.connectors.length - 1)
                ? (openBlock(), createElementBlock("div", {
                    key: 0,
                    class: normalizeClass(_ctx.dark ? 'line--dark' : 'line')
                  }, null, 2 /* CLASS */))
                : createCommentVNode("v-if", true)
            ]))
          }), 128 /* KEYED_FRAGMENT */))
    ...
    renderSlot(_ctx.$slots, "connecting", {}, () => [
      createVNode(_component_Modal, {
